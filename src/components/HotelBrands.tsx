...
const MARQUEE_TEXT = "TRUSTED BY LEADING HOTEL BRANDS WORLDWIDE";

export interface HotelBrandsProps {
  /** Hotel logos from Contentful (homepage.hotelLogos). Falls back to default logos when empty. */
  logos?: Array<{ src: string; alt: string }>;
}

export function HotelBrands({ logos }: HotelBrandsProps) {
